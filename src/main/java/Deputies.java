...
class Deputies {
    ...
    Deputies(List<Integer> IDs, DeputiesOptions o) throws IOException {
        if(o.equals(DeputiesOptions.WithSpends))
            ...
            this.deputies = IDs.parallelStream().map(DeputyBuilder::buildWithTripsAndSpends).collect(Collectors.toList());
    }
